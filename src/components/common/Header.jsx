        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            <nav className="hidden md:ml-8 md:flex space-x-1">
              ...
              {/* Government Projects Link - Show to all authenticated users */}
              {user && (
                <NavigationLink to="/government-projects">
                  Government Projects
                </NavigationLink>
              )}
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg py-2 ring-1 ring-black ring-opacity-5 z-50 border border-gray-200">
                    ...
                    <div className="py-1">
                      ...
                      {/* Government Projects in User Menu */}
                      <NavigationLink to="/government-projects" mobile={true}>
                        <div className="flex items-center space-x-2">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
